...
export function Sidebar({
  ...
  useEffect(() => {
    if (!branchMenuOpen && !profileMenuOpen) {
      return;
    }
  ...
  }, [branchMenuOpen, profileMenuOpen]);
            ...
            >
              ...
              <div className="flex flex-col gap-1">
                {group.items.map((item) => {
                  ...
                  const active = itemActive(item.page, activePage);
                    ...
                    <div key={item.label}>
                      {item.href ? (
                        ...
                        <button
                          ...
                          aria-expanded={canExpandInline ? open : undefined}
                          disabled={disabled}
                          className={cn(
                            "flex h-8 items-center rounded-md text-sm font-medium transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
                            iconOnly
                            ...
                            active &&
                              "bg-sidebar-accent text-sidebar-accent-foreground",
                            disabled &&
                              "cursor-not-allowed opacity-80 hover:bg-transparent hover:text-sidebar-foreground",
                          )}
                        >
                          {itemBody}
                        </button>
